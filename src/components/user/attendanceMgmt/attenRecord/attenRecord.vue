  ...
  <div class="home">
    ...
    <div class="home_main">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="出勤统计" name="first">
          <div class="serach_">
        ...
        <el-tab-pane label="准入管理" name="third">
          <div class="serach_">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
              <el-form-item>
                <el-date-picker
          ...
          <div class="home_main_section">
            <el-table :data="tableData" border style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#001642'}">
              ...
              <el-table-column align="center" show-overflow-tooltip fixed="right" label="操作">
                <template slot-scope="scope">
                  <el-button @click="dialogVisibleds = true" type="text" size="small">准入名单</el-button>
                </template>
              </el-table-column>
            </el-table>
            <!-- 准入名单 -->
            ...
            >
              ...
              <el-table :data="tableData" border style="width: 100%">
                ...
                <el-table-column fixed="right" label="操作">
                  <template slot-scope="scope">
                    <el-button @click="openClickin" type="text" size="small">延长准入</el-button>
                    <el-button type="text" @click="openRemove" ref="remo" size="small">撤销</el-button>
                  </template>
                </el-table-column>
              </el-table>
              <span slot="footer" class="dialog-footer">
                <el-button @click="dialogVisibleds = false">取 消</el-button>
                <el-button type="primary" @click="dialogVisibleds = false">确 定</el-button>
              </span>
            </el-dialog>
          </div>
        </el-tab-pane>
        <el-tab-pane label="体温记录" name="fourth">
          <div class="serach_wen">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
              <el-form-item>
                <el-input v-model="formInline.user" placeholder="姓名"></el-input>
              </el-form-item>
              <el-form-item>
                <el-select v-model="formInline.region" placeholder="体温状况">
                  <el-option label="区域一" value="shanghai"></el-option>
                  <el-option label="区域二" value="beijing"></el-option>
                </el-select>
              </el-form-item>
              ...
              <el-form-item>
                <el-button type="primary" @click="onSubmit">查找</el-button>
                <el-button type="success" @click="dialogDisplay = true">设置</el-button>
              </el-form-item>
            </el-form>
          </div>
          <div class="home_main_sections">
            <el-table :data="tableData" border style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#001642'}">
              <el-table-column
                align="center"
                show-overflow-tooltip
            ...
            >
              <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="低温阈值：">
                  <el-input v-model="formInline.user" placeholder="低温阈值："></el-input>℃
                </el-form-item>
                <el-form-item label="高温阈值：">
                  <el-input v-model="formInline.user" placeholder="高温阈值："></el-input>℃
                </el-form-item>
              </el-form>
              <span slot="footer" class="dialog-footer">
