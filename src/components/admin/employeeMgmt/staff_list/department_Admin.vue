  ...
  <div class="crumbs">
    <div>
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>部门分配</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
      ...
      <el-row>
        ...
        <el-col class="mainRight">
          ...
          <el-dialog
            ...
            width="34%"
          >
            <el-form :inline="true" style="margin-top:14px;" :model="formInline" class="demo-form-inline">
...
export default {
  ...
  methods: {
    ...
    //删除
    open() {
      this.$confirm("员工被移除部门后，与该部门关联关系终止，且该员工恢复无部门状态，是否确认移除？", "提示", {
