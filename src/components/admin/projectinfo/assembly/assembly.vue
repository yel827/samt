<template>
  <el-tabs v-model="activeName" @tab-click="handleClick">
    <el-tab-pane label="项目概况" name="first">
      <el-form :label-position="labelPosition" label-width="60px" :rules="rules" ref="formLabelAlign" :model="formLabelAlign">
        ...
        <el-form-item label="项目地址" class="input_imp" prop="projectAddress">
          <el-select v-model="formLabelAlign.projectAddress" @change="choseProvince" placeholder="省级地区">
            <el-option
